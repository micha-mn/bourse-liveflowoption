...
@AllArgsConstructor
@Entity
@Table(name = "tmp_cry_shiba_seconds")
public class TmpCryShibaSeconds {
	@Id
	 @GeneratedValue(generator = "tmp_cry_shiba_seconds_seq")
	 @GenericGenerator(
	      name = "tmp_cry_shiba_seconds_seq",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "tmp_cry_shiba_seconds_seq"),
