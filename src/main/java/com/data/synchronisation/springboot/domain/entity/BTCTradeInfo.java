...
@AllArgsConstructor
@Entity
@Table(name = "CR_BTC_TRADE_INFO")
public class BTCTradeInfo {
	@Id
	 @GeneratedValue(generator = "CR_BTC_TRADE_INFO_SEQ")
	 @GenericGenerator(
	      name = "CR_BTC_TRADE_INFO_SEQ",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "CR_BTC_TRADE_INFO_SEQ"),
