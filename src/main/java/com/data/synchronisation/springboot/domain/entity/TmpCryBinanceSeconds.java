...
@AllArgsConstructor
@Entity
@Table(name = "tmp_cry_binance_seconds")
public class TmpCryBinanceSeconds {
	@Id
	 @GeneratedValue(generator = "tmp_cry_binance_seconds_seq")
	 @GenericGenerator(
	      name = "tmp_cry_binance_seconds_seq",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "tmp_cry_binance_seconds_seq"),
